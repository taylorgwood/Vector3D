...
TEST(ResolveSphereStuck,givenObjectList_getCorrectVelocitiesAfterCollision)
{
    Vector3 position1{0, -1, 0};
    Vector3 position2{0, 1, 0};
    Vector3 velocity1{0, 0, 0};
    Vector3 velocity2{0, 0, 0};
    Vector3 gravity{0, 0, -9.8};
    float radius{1};
    ...
    Vector3 calculatedVelocity1 = object1->get_velocity();
    Vector3 calculatedVelocity2 = object2->get_velocity();
    Vector3 expectedVelocity1{0, 0.1, 0}; // will need to figure this out when deciding logic for resolving stuck spheres.
    Vector3 expectedVelocity2{0, -0.1, 0};
